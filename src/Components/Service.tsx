...
export default function Service() {
  return (
    <div className='bg-gradient-to-r from-gray-200 via-white to-white my-8' id='service'>

    <div className="container mx-auto py-10  ">
      <Headersection className="text-center my-5">Layanan Kami</Headersection>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {services.map(service => (
          <div key={service.id} className="bg-white shadow-md rounded-lg p-6 text-center hover:bg-gray-800 hover:text-white hover:transition-transform">
